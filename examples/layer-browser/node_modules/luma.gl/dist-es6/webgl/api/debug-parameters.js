...
var BUFFER_PARAMETERS = (_BUFFER_PARAMETERS = {}, _defineProperty(_BUFFER_PARAMETERS, GL.BUFFER_SIZE, { webgl1: 0 }), _defineProperty(_BUFFER_PARAMETERS, GL.BUFFER_USAGE, { webgl1: 0 }), _BUFFER_PARAMETERS);

var FENCE_SYNC_PARAMETERS = [GL.OBJECT_TYPE, // GLenum, type of sync object (always GL.SYNC_FENCE).
...
var FRAMEBUFFER_ATTACHMENT_PARAMETERS = [GL.FRAMEBUFFER_ATTACHMENT_OBJECT_NAME, // WebGLRenderbuffer or WebGLTexture
...
var FRAMEBUFFER_STATUS = (_FRAMEBUFFER_STATUS = {}, _defineProperty(_FRAMEBUFFER_STATUS, GL.FRAMEBUFFER_COMPLETE, 'Success. Framebuffer is correctly set up'), _defineProperty(_FRAMEBUFFER_STATUS, GL.FRAMEBUFFER_INCOMPLETE_ATTACHMENT, 'Framebuffer attachment types mismatched or some attachment point not attachment complete'), _defineProperty(_FRAMEBUFFER_STATUS, GL.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT, 'Framebuffer has no attachment'), _defineProperty(_FRAMEBUFFER_STATUS, GL.FRAMEBUFFER_INCOMPLETE_DIMENSIONS, 'Framebuffer attachments do not have the same size'), _defineProperty(_FRAMEBUFFER_STATUS, GL.FRAMEBUFFER_UNSUPPORTED, 'Framebuffer attachment format not supported or depth and stencil attachments are not same'), _defineProperty(_FRAMEBUFFER_STATUS, GL.FRAMEBUFFER_INCOMPLETE_MULTISAMPLE, 'Framebuffer attachement SAMPLES differs among renderbuffers, or are mixed with textures'), _FRAMEBUFFER_STATUS);

var PROGRAM_PARAMETERS = (_PROGRAM_PARAMETERS = {}, _defineProperty(_PROGRAM_PARAMETERS, GL.DELETE_STATUS, { webgl1: 0 }), _defineProperty(_PROGRAM_PARAMETERS, GL.LINK_STATUS, { webgl1: 0 }), _defineProperty(_PROGRAM_PARAMETERS, GL.VALIDATE_STATUS, { webgl1: 0 }), _defineProperty(_PROGRAM_PARAMETERS, GL.ATTACHED_SHADERS, { webgl1: 0 }), _defineProperty(_PROGRAM_PARAMETERS, GL.ACTIVE_ATTRIBUTES, { webgl1: 0 }), _defineProperty(_PROGRAM_PARAMETERS, GL.ACTIVE_UNIFORMS, { webgl1: 0 }), _defineProperty(_PROGRAM_PARAMETERS, GL.TRANSFORM_FEEDBACK_BUFFER_MODE, { webgl2: 0 }), _defineProperty(_PROGRAM_PARAMETERS, GL.TRANSFORM_FEEDBACK_VARYINGS, { webgl2: 0 }), _defineProperty(_PROGRAM_PARAMETERS, GL.ACTIVE_UNIFORM_BLOCKS, { webgl2: 0 }), _PROGRAM_PARAMETERS);

//  parameters
var RENDERBUFFER_PARAMETERS = (_RENDERBUFFER_PARAMET = {}, _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_WIDTH, { webgl1: 0 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_HEIGHT, { webgl1: 0 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_INTERNAL_FORMAT, { type: 'GLenum', webgl1: GL.RGBA4 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_GREEN_SIZE, { webgl1: 0 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_BLUE_SIZE, { webgl1: 0 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_RED_SIZE, { webgl1: 0 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_ALPHA_SIZE, { webgl1: 0 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_DEPTH_SIZE, { webgl1: 0 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_STENCIL_SIZE, { webgl1: 0 }), _defineProperty(_RENDERBUFFER_PARAMET, GL.RENDERBUFFER_SAMPLES, { webgl2: 1 }), _RENDERBUFFER_PARAMET);

var SAMPLER_PARAMETERS = (_SAMPLER_PARAMETERS = {}, _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_MAG_FILTER, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_MIN_FILTER, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_WRAP_S, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_WRAP_T, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_WRAP_R, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_BASE_LEVEL, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_MAX_LEVEL, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_COMPARE_FUNC, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_COMPARE_MODE, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_MIN_LOD, { webgl2: true }), _defineProperty(_SAMPLER_PARAMETERS, GL.TEXTURE_MAX_LOD, { webgl2: true }), _SAMPLER_PARAMETERS);
...
var TEXTURE_PARAMETERS = (_TEXTURE_PARAMETERS = {}, _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_MAG_FILTER, { type: 'GLenum', webgl1: GL.LINEAR }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_MIN_FILTER, { type: 'GLenum', webgl1: GL.NEAREST_MIPMAP_LINEAR }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_WRAP_S, { type: 'GLenum', webgl1: GL.REPEAT }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_WRAP_T, { type: 'GLenum', webgl1: GL.REPEAT }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_WRAP_R, { type: 'GLenum', webgl2: GL.REPEAT }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_BASE_LEVEL, { webgl2: 0 }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_MAX_LEVEL, { webgl2: 1000 }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_COMPARE_FUNC, { type: 'GLenum', webgl2: GL.LEQUAL }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_COMPARE_MODE, { type: 'GLenum', webgl2: GL.NONE }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_MIN_LOD, { webgl2: -1000 }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_MAX_LOD, { webgl2: 1000 }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_WIDTH, { webgl1: 0 }), _defineProperty(_TEXTURE_PARAMETERS, GL.TEXTURE_HEIGHT, { webgl1: 0 }), _TEXTURE_PARAMETERS);
